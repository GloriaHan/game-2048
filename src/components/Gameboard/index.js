    ...
    return (
      <div className="root">
        ...
        <div className="keyboard">
          <button onClick={() => this.handleOnKeydown({keyCode:38})}>&#8593;</button>
          <button onClick={() => this.handleOnKeydown({keyCode:40})}>&#8595;</button>
          <button onClick={() => this.handleOnKeydown({keyCode:37})}>&#8592;</button>
          <button onClick={() => this.handleOnKeydown({keyCode:39})}>&#8594;</button>
        </div>
      </div>
    )
  }
